    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{route('add_sub_category')}}" class="btn btn-primary">New Sub Category</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
                            ...
                            @if ($subcategories->isNotEmpty())
                                @foreach ($subcategories as $subcategory)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('edit_sub_category', $subcategory->id) }}">
...
<script>
    function deleteSubCategory(id){
        ...
        var url= '{{ route("delete_sub_category", "id") }}';
        ...
        if(confirm('Are you sure you want to delete?')){
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    ...
                    alert('An error occurred while trying to delete the sub-category.');
                }
            });
