...
<html lang="en">
    ...
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="{{ asset('') }}public/client_asset/images/favicon.ico">

        <!-- Libs CSS -->

        <link href="{{ asset('') }}public/client_asset/css/bootstrap-icons.css" rel="stylesheet" />
        <link href="{{ asset('') }}public/client_asset/css/feather-icons.css" rel="stylesheet" />
        <link href="{{ asset('') }}public/client_asset/css/slick.css" rel="stylesheet" />
        <link href="{{ asset('') }}public/client_asset/css/slick-theme.css" rel="stylesheet" />
        <link href="{{ asset('') }}public/client_asset/css/simplebar.min.css" rel="stylesheet" />
        <link href="{{ asset('') }}public/client_asset/css/nouislider.min.css" rel="stylesheet">
        <link href="{{ asset('') }}public/client_asset/css/tiny-slider.css" rel="stylesheet">
        <link href="{{ asset('') }}public/client_asset/css/dropzone.min.css" rel="stylesheet" />
        <link href="{{ asset('') }}public/client_asset/css/prism-okaidia.min.css" rel="stylesheet">
        <link href="{{ asset('') }}public/client_asset/css/theme.min.css" rel="stylesheet">
        <!-- Theme CSS -->
    ...
    <div class="border-bottom pb-5">
        ...
        <div class="container">
            ...
            <div class="col-xxl-2 col-lg-3">
                ...
                <img src="{{ asset('') }}public/client_asset/images/cc-logo.png" alt="eCommerce HTML Template">
            ...
            <div class="col-md-2 col-xxl-1 text-end d-none d-lg-block">
                ...
                <div class="list-inline-item">
                    ...
                    <a href="wish_list.html" class="text-muted position-relative">
        ...
        <div>
            ...
            <ul class="list-group list-group-flush">
                ...
                <div class="row align-items-center">
                    ...
                    <img src="{{ asset('') }}public/client_asset/images/product-img-1.jpg" alt="Ecommerce" class="img-fluid">
                ...
                <div class="row row align-items-center">
                    ...
                    <img src="{{ asset('') }}public/client_asset/images/product-img-2.jpg" alt="Ecommerce" class="img-fluid">
                ...
                <div class="row row align-items-center">
                    ...
                    <img src="{{ asset('') }}public/client_asset/images/product-img-3.jpg" alt="Ecommerce" class="img-fluid">
                ...
                <div class="row row align-items-center">
                    ...
                    <img src="{{ asset('') }}public/client_asset/images/product-img-4.jpg" alt="Ecommerce" class="img-fluid">
                ...
                <div class="row row align-items-center">
                    ...
                    <img src="{{ asset('') }}public/client_asset/images/product-img-5.jpg" alt="Ecommerce" class="img-fluid">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="mb-8 mb-xl-0">
                    <div class="mb-6"><img src="{{ asset('') }}public/client_asset/images/clock.svg" alt=""></div>
                    <h3 class="h5 mb-3">
                ...
                <div class="col-md-6  col-lg-3">
                <div class="mb-8 mb-xl-0">
                    <div class="mb-6"><img src="{{ asset('') }}public/client_asset/images/gift.svg" alt=""></div>
                ...
                <div class="col-md-6 col-lg-3">
                <div class="mb-8 mb-xl-0">
                    <div class="mb-6"><img src="{{ asset('') }}public/client_asset/images/package.svg" alt=""></div>
                ...
                <div class="col-md-6 col-lg-3">
                <div class="mb-8 mb-xl-0">
                    <div class="mb-6"><img src="{{ asset('') }}public/client_asset/images/refresh-cw.svg" alt=""></div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5 text-lg-start text-center mb-2 mb-lg-0">
                        <ul class="list-inline mb-0">
                            ...
                            <a href="#!"><img src="{{ asset('') }}public/client_asset/images/amazonpay.svg" alt=""></a>
                            </li>
                            <li class="list-inline-item">
                            <a href="#!"><img src="{{ asset('') }}public/client_asset/images/american-express.svg" alt=""></a>
                            </li>
                            <li class="list-inline-item">
                            <a href="#!"><img src="{{ asset('') }}public/client_asset/images/mastercard.svg" alt=""></a>
                            </li>
                            <li class="list-inline-item">
                            <a href="#!"><img src="{{ asset('') }}public/client_asset/images/paypal.svg" alt=""></a>
                            </li>
                            <li class="list-inline-item">
                            <a href="#!"><img src="{{ asset('') }}public/client_asset/images/visa.svg" alt=""></a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-7 mt-4 mt-md-0">
                        <ul class="list-inline mb-0 text-lg-end text-center">
                            ...
                            <a href="#!"> <img src="{{ asset('') }}public/client_asset/images/appstore-btn.svg" alt="" style="width: 140px;"></a>
                            </li>
                            <li class="list-inline-item">
                            <a href="#!"> <img src="{{ asset('') }}public/client_asset/images/googleplay-btn.svg" alt="" style="width: 140px;"></a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <ul class="list-inline text-md-end mb-0 small mt-3 mt-md-0">
                            ...
                            <a href="#!" class="icon-shape icon-sm social-links"> <svg xmlns="http://www.w3.org/2000/svg" width="16"
    ...
    <!-- Javascript-->
    <script src="{{asset('')}}public/client_asset/js/vendors/validation.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.8/dist/umd/popper.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/js/bootstrap.min.js"></script>
    <script src="{{asset('')}}public/client_asset/js/feather.min.js"></script>
    <!-- Libs JS -->
    <script src="{{asset('')}}public/client_asset/js/jquery.min.js"></script>
    {{-- <script src="{{asset('')}}public/client_asset/js/bootstrap.bundle.min.js"></script> --}}
    <script src="{{asset('')}}public/client_asset/js/jquery.countdown.min.js"></script>
    <script src="{{asset('')}}public/client_asset/js/slick.min.js"></script>
    <script src="{{asset('')}}public/client_asset/js/simplebar.min.js"></script>
    <script src="{{asset('')}}public/client_asset/js/nouislider.min.js"></script>
    <script src="{{asset('')}}public/client_asset/js/wNumb.min.js"></script>
    <script src="{{asset('')}}public/client_asset/js/index.js"></script>
    <script src="{{asset('')}}public/client_asset/js/prism.js"></script>
    <script src="{{asset('')}}public/client_asset/js/prism-scss.min.js"></script>
    <script src="{{asset('')}}public/client_asset/js/prism-toolbar.min.js"></script>
    <script src="{{asset('')}}public/client_asset/js/prism-copy-to-clipboard.min.js"></script>
    <script src="{{asset('')}}public/client_asset/js/tiny-slider.js"></script>
    <script src="{{asset('')}}public/client_asset/js/dropzone.min.js"></script>
    <script src="{{asset('')}}public/client_asset/js/flatpickr.min.js"></script>

    <!-- Theme JS -->
    <script src="{{asset('')}}public/client_asset/js/theme.min.js"></script>
